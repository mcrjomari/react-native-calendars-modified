...
export default class BasicDay extends Component {
  ...
  onPress = () => {
   // if(typeof this.props.setSelDate === 'function'){
    ...
    // if(this.props.setSelDate === undefined){
    //   _.invoke(this.props, 'onPress', this.props.date);
    //   _.invoke(this.props, 'onPress', this.props.date);
    // setTimeout(()=>{
    //   _.invoke(this.props, 'onPress', this.props.date);
    ...
    // console.log('preee',this.props)
  }
  
  onLongPress = () => {
    _.invoke(this.props, 'onLongPress', this.props.date);
    // if(this.props.setSelDate === undefined){
    //  // this.props.setSelDate(this.props.date.dateString)
    //  _.invoke(this.props, 'onLongPress', this.props.date);
    //  setTimeout(()=>{
    //    _.invoke(this.props, 'onPress', this.props.date);
    //    setTimeout(()=>{
