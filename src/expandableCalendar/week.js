...
class Week extends Component {
  ...
  getState(day) {
    const {current, disabledByDefault,tz,getNow} = this.props;
    //const tM = changeTimezone(new Date(),tz)
    ...
    const ttDay = moment.utc(moment.tz(tz)).format('YYYY-MM-DD')
  ...
  renderDay(day, id) {
    const {current, hideExtraDays,setSelDate} = this.props;
